...
public class EnterpriseController {
    ...
    @Autowired
    private EnterpriseService recruitService;
    ...
    public ResultDTO listRecommend(){
        return new ResultDTO(true, StatusCode.OK, "查询成功",recruitService.findRecruitListTop4ByStateOrderByCreatetimeDesc("2"));
    }

    /**
     * 查询最新职位列表的前12条记录,不能是关闭状态
     * @return
     */
    @GetMapping("/search/newlist")
    public ResultDTO listNew(){
        return new ResultDTO(true, StatusCode.OK, "查询成功",recruitService.findRecruitListNewTop12());
    }
}
