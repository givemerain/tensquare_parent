...
public class EnterpriseService {
	 ...
	 * @return
	 */
	public List<Recruit> findRecruitListTop4ByStateOrderByCreatetimeDesc(String state){
		return recruitRepository.findTop4ByStateOrderByCreatetimeDesc(state);
	}
	 ...
	 * @return
	 */
	public List<Recruit> findRecruitListNewTop12(){
